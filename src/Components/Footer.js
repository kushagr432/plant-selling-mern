            ...
            <div className="container">
                ...
                <section className="d-flex flex-column justify-content-center justify-content-lg-between">
                    ...
                    <div>
                        ...
                        <Link to="https://www.linkedin.com/in/kushagr-jain-40502621b/" className="me-4 link-secondary">
                            <i className="fab fa-linkedin"></i>
                        </Link>
                        <Link to="https://github.com/kushagr432" className="me-4 link-secondary">
                ...
                <div className="text-center p-4" style={{ backgroundColor: "rgba(0, 0, 0, 0.025)" }}>
                    © 2021 Copyright:
                    <Link className="text-reset fw-bold" to="/"> Kushagr Jain</Link>
                </div>
            </div>
        </footer>
    )
